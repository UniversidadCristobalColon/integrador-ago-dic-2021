                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-5 col-md-10 col-sm-11 mb-3">
                        ...
                        <div class="card bg-light">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a data-bs-toggle="offcanvas" href="#quotationDetail" role="button" aria-controls="offcanvasRight"><u>N° Orden <?php echo $id_cotizacion ?></u></a></h5>
                            ...
                            <div class="field_wrapper">
                                <div class="row">
                                    <div class="col-3 w-100">
                                        <select name="paqueteria_name[]" class="w-100 myOwnSelect" required>
                                            <?php
